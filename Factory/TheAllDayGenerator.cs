...
//Factory Method specfically it generates the All Day menu

using System.Collections.Generic;

namespace Factory
{
    public class TheAllDayGenerator : IGeneratorFactoryMethod
    {
        public List<FoodItemData> TheGenerator(List<FoodItemData> theFood)
        {
            ...
            {
                //Makes a new list of FoodItemDatas for the All Day menu
                if (food.category.ToString().Equals("Breakfast") || food.category.ToString().Equals("Lunch")
                    || food.category.ToString().Equals("Snack") || food.category.ToString().Equals("Side Dish")
                    || food.category.ToString().Equals("Appetizer") || food.category.ToString().Equals("Dinner")
